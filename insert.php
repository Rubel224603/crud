						...
						<form action="store.php" method= "POST">
							 ...
							 <div class="form-group ">
								...
								<label for="Age" >Position :</label>
									<input type="text" class="form-control" id="" name ="position" placeholder="Position"/>
								</div>
							 <div class="form-group ">
							  
								<label for="Adress" >Adress :</label>
									<input type="text" class="form-control" name ="adress" id="" placeholder="Adress"/>
								</div>
							 <div class="form-group ">
							  
								<label for="Mobaile" >Mobaile Number :</label>
									<input type="number" class="form-control" name ="mobile" id="" placeholder="Mobile Number"/>
								</div>
